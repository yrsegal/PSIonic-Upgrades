                        ...
                        for (item in items) {
                            ...
                            if (itemstack != null && itemstack.item === Items.BUCKET && !world.isRemote) {
                                while (itemstack.count > 0) {
                                    ...
                                    ent?.motionY = ent?.motionY?.plus(world.rand.nextFloat() * 0.05f)
                                    ent?.motionX = ent?.motionX?.plus((world.rand.nextFloat() - world.rand.nextFloat()) * 0.1f)
                                    ent?.motionZ = ent?.motionZ?.plus((world.rand.nextFloat() - world.rand.nextFloat()) * 0.1f)
                                    itemstack.count--
                                }
                                item.setDead()
                            }
