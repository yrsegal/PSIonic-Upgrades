 ...
 */
open class ItemModArmor(name: String, material: ArmorMaterial, type: Int, entityEquipmentSlot: EntityEquipmentSlot, vararg variants: String) : ItemArmor(material, type, entityEquipmentSlot), ModelHandler.IVariantHolder {
